...
Получить бота возможно только вступив в приватный чат: https://t.me/+-bZ9Thw-U3U1Njli

В приватный чат могут попасть, **только рефералы**: https://t.me/gift_kombat_bot?startapp=252453226
...
Используйте бота на свой страх и риск и в соответствии с применимым законодательством и условиями использования сторонних сервисов.## ⚙️ Настройки
